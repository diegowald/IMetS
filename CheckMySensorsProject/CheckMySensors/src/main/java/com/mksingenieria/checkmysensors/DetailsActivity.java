package com.mksingenieria.checkmysensors;
...
import com.mksingenieria.checkmysensors.adapter.CommandModelAdapter;
import com.mksingenieria.checkmysensors.adapter.HistoryAdapter;
...
public class DetailsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new PlaceholderFragment(isNewRecord, phone))
                    .commit();
        }
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private String phone;
        View rootView;
        public PlaceholderFragment(boolean newRecord, String phone) {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String  phone = ((TextView) rootView.findViewById(R.id.phone_number)).getText().toString();
                String name = ((TextView)rootView.findViewById(R.id.device_description)).getText().toString();
                Spinner spinner = (Spinner) rootView.findViewById(R.id.device_model);
                String model = spinner.getItemAtPosition(spinner.getSelectedItemPosition()).toString();
                DatabaseHelper databaseHelper = new DatabaseHelper(view.getContext());
                if (newRecord) {
                    Device device = new Device(-1, phone, name, model);
